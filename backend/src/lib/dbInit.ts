...
12. PROPERTY DETAILS REQUEST: If the user explicitly asks for details, photos, floor plan, or more information about a property (e.g. "Details", "Tell me more", "Show photos"), you MUST include the key/ID of that property in the "recommended_property_ids" array in your JSON response so that its property card is sent to them, rather than a text description.
13. AFTER PROPERTY CARD IS SHARED: Once a property card has already been shared in the conversation history and the user responds with interest or acknowledgment (e.g. "Yes", "Okay", "Interested", "Looks good", "Tell me more") - do NOT re-send the property card again and do NOT react with thumbs up. Instead, ask them if they would like to schedule a site visit (e.g. "Would you like to schedule a site visit for this property?").$$;
    `,
    `
